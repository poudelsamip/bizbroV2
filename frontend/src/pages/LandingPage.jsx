                ...
                {mobileMenuOpen && (
                    ...
                    >
                        <div className="flex flex-col gap-4">
                            {["Features", "Testimonials", "Contact"].map(
                                (item) => (
                                    <a
                                        key={item}
                                        href={`#${item.toLowerCase()}`}
                            ...
                            <div className="pt-2 border-t flex flex-col gap-2">
                                <Link
                                    to={"/login"}
                                    className="py-2 rounded-full text-center border text-gray-700 font-semibold "
                                >
                                    Sign In
                                </Link>
                                <Link
                                    to={"/register"}
                                    className="py-2 rounded-full text-center bg-linear-to-r from-blue-600 to-indigo-600 text-white font-semibold shadow"
                                >
                                    Get Started
                                </Link>
                            </div>
            ...
            <div className="relative min-h-[90vh] flex items-center bg-white pt-24 overflow-hidden">
                ...
                #1 Business Platform
                            ...
                            <p className="text-base sm:text-lg text-gray-600 max-w-xl mx-auto md:mx-0 mb-8">
                                Manage inventory, sales, customers, and insights
                                — all in one powerful platform built for growth.
                            </p>

                            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                                <Link
                                    to={"/register"}
                                    className="px-7 py-3 bg-blue-600 text-white rounded-full font-semibold hover:bg-blue-700 transition shadow-lg flex items-center justify-center gap-2"
                                >
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-600 leading-relaxed">
                            Enterprise-grade tools designed to simplify
                            operations, boost productivity, and scale
                            confidently.
                        </p>
                    </motion.div>
                            ...
                            {[
                                {
                                    icon: MapPin,
                                    label: "Address",
                                    value: "Bharatpur, Chitwan",
                                },
                                {
                                    icon: Phone,
                                    label: "Phone",
                                    value: "+977 9845012367",
                                },
                                {
                                    icon: Mail,
                                    label: "Email",
                                    value: "support@bizbro.com",
                                },
                                {
                                    icon: Clock,
                                    label: "Hours",
                                    value: "Sun–Fri, 10AM–5PM",
                                },
                            ].map((item, i) => (
                                <div
                                    key={i}
            ...
            <div className="border-t-2 border-gray-200 px-6 md:px-16 lg:px-24 py-12 bg-gray-50">
                <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-6">
                    ...
                    <p className="text-gray-500 text-sm font-medium">
                        © {new Date().getFullYear()} Samip Poudel. All Rights
                        Reserved.
                    </p>
                </div>
            </div>
